...
int main(int argc, char** argv)
{
    ...
    std::vector<Measurement<std::chrono::seconds>> hostToDeviceMeasurements;
    std::vector<Measurement<std::chrono::seconds>> saxpySlowMeasurements;
    std::vector<Measurement<std::chrono::seconds>> saxpyFastMeasurements;
    std::vector<Measurement<std::chrono::seconds>> deviceToHostMeasurements;
    ...
    for (int size = 1; size < 10e9; size *= 10)
    {
        ...
        // copy to device
        Measurement<std::chrono::seconds> hostToDeviceMeasurement;
        ...
        // saxpy_slow
        Measurement<std::chrono::seconds> saxpySlowMeasurement;
        cudaDeviceSynchronize();
        ...
        // copy to host
        Measurement<std::chrono::seconds> deviceToHostMeasurement;
        cudaDeviceSynchronize();
